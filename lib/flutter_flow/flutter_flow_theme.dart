...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color champagnePink = const Color(0xFFE8D6CB);
  late Color teaRoseRed = const Color(0xFFD0ADA7);
  late Color redwood = const Color(0xFFAD6A6C);
  late Color violetJTC = const Color(0xFF5D2E46);
